...
data = pd.read_csv('../../../../data/spectrophotometry/2021-08-04_water_comparison/2021-08-04_water_comparison.csv')

tidy, params, opts = fp.growth.infer_growth_rate(data, 
                                                 groupby=['water_source', 'micronutrients'],
                                                 od_bounds=[0.04, 0.4], 
                                                 print_params=True)
...
points = alt.Chart(tidy, 
                   ...
                   height=200
                    ...
                    color=alt.Color('water_source:N', 
                                    title='water source', 
                                    scale=alt.Scale(scheme='tableau10'))
            ).facet(column=alt.Column('micronutrients:N', 
