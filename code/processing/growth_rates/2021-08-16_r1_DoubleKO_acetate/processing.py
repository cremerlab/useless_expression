...
* This script drops replicate 1 of ∆opp ∆rbs which had an obvious instrument 
error with a large jump in the OD for a period of time followed by a drop.
"""
#%%
import numpy as np 
import pandas as pd 
