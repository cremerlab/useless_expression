...
* This script drops replicate 3 of the ∆pot measurements as the inoculum in this
well was too large, making the lag phase prevalent in the OD range considered here.
"""
#%%
import numpy as np 
import pandas as pd 
