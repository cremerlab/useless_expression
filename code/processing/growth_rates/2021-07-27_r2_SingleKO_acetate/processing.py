...
*  This script drops replicatee 1 of the ∆rbs sample as there was an obvious 
glitch in the instrument, causing a very sudden drop in OD, but with approximately
the same point-to-point growth rate. 
"""
#%%
import numpy as np 
import pandas as pd 
