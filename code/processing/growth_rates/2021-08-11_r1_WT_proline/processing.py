...
DILUTION_MAP = {10: ['C3', 'C4', 'C5', 'C6', 'E3', 'E4', 'E5', 'E6'],
                20: ['D3', 'D4', 'D5', 'D6', 'F3', 'F4', 'F5', 'F6']}

MICRONUTRIENT_MAP = {True: ['C3', 'C4', 'C5', 'C6','D3', 'D4', 'D5', 'D6'], 
                    False: ['E3', 'E4', 'E5', 'E6', 'F3', 'F4', 'F5', 'F6']}
...
for dil, wells in DILUTION_MAP.items():
    for idx, well in enumerate(wells):
        melted.loc[melted['well']==well, 'strain'] = 'WT'
        melted.loc[melted['well']==well, 'dilution_factor'] = dil
...
trunc = []
for g, d in measurement.groupby(['dilution_factor', 'micronutrients', 'replicate']):
    d = d.copy()
...
trunc = trunc[['strain', 'dilution_factor', 'micronutrients', 'elapsed_time_hr', 
