...
status: >
    Accepted
description : >
    Data looks good and there's no reason not to accept the data.
---

# 2021-08-17 (Run 2) Double KO Acetate Growth Rate Determination
...
## Notes & Results
There's nothing of note with this experiment and it should be accepted outright.
